...
transformEquivalence f1 f2 = Conjunct (Conjunct (Negation f1) f2) (Conjunct (Negation f2) f1)

transformXor :: StateFormula -> StateFormula -> StateFormula
transformXor f1 f2 = Conjunct (Conjunct (Negation f1) f2) (Conjunct (Negation f2) f1)
